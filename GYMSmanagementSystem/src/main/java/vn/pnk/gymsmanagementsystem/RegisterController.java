...
public class RegisterController implements Initializable {
    ...
    @FXML
    private Hyperlink ReturnLoginMessange;
    /**
    ...
    @FXML
    private void ReturnLoginAction(ActionEvent event) throws IOException {
        Stage currentStage = (Stage) ReturnLoginMessange.getScene().getWindow(); 
        App.setRoot(currentStage, "login", 600, 400);
    }
}
